...
const Navbar = () => {
    ...
    const simulators = [
        { name: 'Impact Simulator', path: '/tools/impact-simulator', icon: Sprout, color: 'text-green-600', bg: 'bg-green-50 dark:bg-green-900/30' },
                ...
                <div className="hidden md:flex gap-1 items-center bg-transparent shrink-0">
                    ...
                    <div className="relative group">
                        ...
                        >
                            ...
                            <span className="whitespace-nowrap">Simulators</span>
                            <ChevronDown className="h-3 w-3 opacity-60 shrink-0" />
                        </button>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute top-full right-0 mt-2 min-w-[14rem] w-max max-w-xs bg-white rounded-xl shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 py-1 dark:bg-slate-800 dark:border-slate-700">
                                ...
                                <Link to="/" className="w-full text-left px-4 py-2 text-[13px] text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors flex items-start gap-2 dark:text-slate-300 dark:hover:bg-slate-700 dark:hover:text-white">
                                    ...
                                    <span className="break-words leading-tight">Dashboard</span>
                                </Link>
                                ...
                                <Link to="/help" className="w-full text-left px-4 py-2 text-[13px] text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors flex items-start gap-2 border-b border-gray-50 pb-2 dark:text-slate-300 dark:hover:bg-slate-700 dark:hover:text-white dark:border-slate-700/50">
                                    ...
                                    <span className="break-words leading-tight">Help & Support</span>
                                </Link>
                                <button
                                    onClick={logout}
                                ...
                                >
                                    ...
                                    <span className="break-words leading-tight">Log Out</span>
                                </button>
                            </div>
                        </div>
                    ) : (
                ...
                {isOpen && (
                        ...
                        >
                            <div className="px-3 py-4 space-y-5 max-h-[80vh] overflow-y-auto no-scrollbar">
                                ...
                                {/* Mobile Simulators */}
                                <div>
                                    <div className="px-2 text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-widest mb-2">Advanced Simulations</div>
                                    <div className="grid grid-cols-2 gap-2">
                                        {simulators.map((item) => (
                                            <Link
                                                ...
                                                to={item.path}
                                                onClick={() => setIsOpen(false)}
                                                className="flex flex-col items-start p-2.5 rounded-xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 hover:border-emerald-500/50 active:scale-95 transition-all"
                                            >
                                                <div className={`p-1.5 rounded-lg mb-2 ${item.bg} ${item.color} shadow-sm`}>
                                                    <item.icon className="h-4 w-4" />
                                                </div>
                                                <span className="text-[11px] font-bold text-gray-700 dark:text-slate-200 leading-tight">{item.name}</span>
                                            </Link>
                                        ))}
                                    </div>
                                </div>
